...
import com.example.bossdrop.data.repository.GameSearchRepository
...
import com.example.bossdrop.adapter.SearchResultsAdapter
...
class FavoritesActivity : AppCompatActivity() {
    ...
    private fun addGameToFavorites(game: com.example.bossdrop.data.repository.SearchResult) {
        lifecycleScope.launch {
